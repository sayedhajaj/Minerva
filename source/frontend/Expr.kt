...
sealed class Expr {
    class Array(val values: List<Expr>): Expr()
    ...
    class Get(val obj: Expr, val name: Token, val index: Expr?): Expr()
    ...
    class Set(val obj: Expr, val name: Token, val value: Expr, val index: Expr?): Expr()
